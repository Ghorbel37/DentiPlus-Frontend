...
class ScheduleTab2 extends StatefulWidget {
  const ScheduleTab2({
    super.key,
  });

  @override
  State<ScheduleTab2> createState() => _ScheduleTab1State();
}

class _ScheduleTab1State extends State<ScheduleTab2> {
  ...
  Widget build(BuildContext context) {
    final appointments =
        context.watch<AppointmentProvider>().completeAppointments;
